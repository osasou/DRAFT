...
% decide_p_b
[p_bits1, p_bits2, p_bits3, b_bits1, b_bits2, b_bits3] = decide_p_b(re, m, B, b_set_bits);
...
for ebn0 = start_ebn0:EbN0
    ...
    for i = 1:trials
        this_prop = 0;
        [prop, input_bits, output_bits, ave_dist, h_output] = run(re, m, p, ebn0, user_num, slots, without_h, without_sigma, p_bits1, p_bits2, p_bits3, b_bits1, b_bits2, b_bits3);
%         disp("this prop")
%         disp(this_prop)
         output=[];
...
%         mesg = [input_bits_all(:,1),input_bits_all(:,2),input_bits_all(:,3),input_bits_all(:,4),input_bits_all(:,5)];
        ...
        rec1 = output_bits_all(:,1);
        rec2 = output_bits_all(:,2);
        rec3 = output_bits_all(:,3);
%         
%         cnt = 0;
